...
import { getDistrict, getInfoBuilding, getTypeCode, updateBuilding } from "../../../../Services/BuildingServices";
          ...
          <Row gutter={[20]}>
            ...
            <Col span={12}>
              ...
              {result?.uploadfileString && (
                <div>
                  <Image src={result?.uploadfileString} alt="loading..." width={100} height={100}/>
                </div>
              )}
            </Col>
            <Col span={12}>
