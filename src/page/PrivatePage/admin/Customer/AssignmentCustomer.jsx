...
import { assignmentCustomer, getInfoUserAssignment } from '../../../../Services/CustomerServices';
import { DeliveredProcedureOutlined } from "@ant-design/icons";


export default function AssignmentCustomer(props) {
  const { record } = props;
  ...
  const handleClick=async(idBuilding)=>{
     ...
     const res=await assignmentCustomer(obj,token);
     if(res.code===200){
      messageAPI.open({
        type: "success",
